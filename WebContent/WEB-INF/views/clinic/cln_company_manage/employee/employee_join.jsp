      ...
      <div class="row">
        <div class="span12">
         <div class="page-header">
          ...
          <tr>
          	<td >
                <input class="input-large" type="text" placeholder="아이디" id="id" name="id" maxlength="20" style="display: inline-block;">
                <a href=""><img src="http://localhost:8080/mkjg/clinic/images/check.png" style="margin-bottom: 12px; margin-left: 8px;"></a>
                <br/><br/>
            </td>
          </tr>
          <tr>
          ...
          <tr>
          	<td >
                <input class="input-xxlarge" type="text" placeholder="이름" id="name" name="name" maxlength="10"><br/>
            </td>
           </tr>
            <tr>
          	<td>
                <input type="radio" id="gender" name="gender" class="radio" style="margin-left: 10px; width: 15px; margin-bottom: 6px;">&nbsp;남자&nbsp;&nbsp;|
                <input type="radio" id="gender" name="gender" class="radio" style="margin-left: 10px; width: 15px; margin-bottom: 6px;">&nbsp;여자<br/><br/>
             </td> 
             </tr>  
           <tr>
          	<td>
                <input class="input-xxlarge" type="text" placeholder="생년월일 ex) 1991-01-01" id="birth" name="birth" maxlength="10"><br/>
           </td>
           </tr>
           <tr>
          	<td>
