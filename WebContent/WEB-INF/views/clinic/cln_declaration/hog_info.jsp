        ...
        <div class="span12">
         <div class="page-header">
          ...
          <tr>
           ...
           <tr>
          	<td>
                <textarea name="reason" rows="10" cols="35" maxlength="1000" style="width: 530px;" id="reason" readonly="readonly" placeholder="사유"></textarea>
           </td>
           </tr>
          ...
          <table>
          	<tr>
          	<td>
                <textarea name="refuse" rows="15" cols="35" maxlength="1000" style="width: 530px;" id="refuse" readonly="readonly" placeholder="거절사유"></textarea>
           </td>
          </tr>
	         <tr>
	         	<td>
