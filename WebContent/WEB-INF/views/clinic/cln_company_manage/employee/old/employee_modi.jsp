...
<html>
	<head>
		...
		$("#join").click(function(){
			...
			if($("#addr1").val() == ""){
				alertCenter("#addr1", "#addrAlert", "우편번호를 입력해주세요");
				return;
			}//end if
       	 
			if($("#addr2").val() == ""){
				alertCenter("#addr2", "#addrAlert", "우편번호를 입력해주세요");
				return;
			}//end if
							...
							<!-- Content -->
								<article>
									...
									<tr>
										<td id="info">아이디</td>
										<td id="input">
											<input type="text" id="id" name="id" maxlength="20" readonly="readonly" class="inputBox">&nbsp;&nbsp; 
										</td>
									</tr>
										<tr>
										<td id="info">비밀번호</td>
										...
										<td id="info">이름</td>
										<td id="input">
											 <input type="text" id="name" name="name" maxlength="10" readonly="readonly" class="inputBox">
										</td>
									</tr>
										<tr>
										<td id="info">성별</td>
										<td id="input">
											<input type="text" id="gender" name="gender" readonly="readonly" class="inputBox">
										</td>
									</tr>
										<tr>
										<td id="info">생년월일</td>
										<td id="input">
											 <input type="text" id="birth" name="birth" maxlength="10" readonly="readonly" class="inputBox">
										</td>
									</tr>
										<tr>
										<td id="info">전화번호</td>
										...
										<td id="info"></td>
										<td>
										<input type="button" id="join" name="join" value="수정"  class="btn">
										</td>
									</tr>
									</table>
									</div>
