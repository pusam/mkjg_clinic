						...
						<div id="content">
							<!-- Content -->
								<article>
									...
									<div style="text-align: center">ㄴ
									<img src="http://localhost:8080/mkjg/clinic/images/ok.png">
									<br/>
									<div style="font-size: 40px; font-weight: bold;">
										<p>직원 등록이 완료되었습니다.</p>
									</div>
									<input type="button" id="home" name="home" value="홈" class="btn">
									<input type="button" id="list" name="list" value="목록" class="btn">
									</div>
									<br/><br/><br/><br/><br/><br/>
								</article>
						</div>
