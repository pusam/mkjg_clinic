...
<html>
	<head>
		...
		$("#regi").click(function(){
			alert($("#treatment").val());
			if($("#treatment").val() == ""){
				alertCenter("#treatment", "#treatmentAlert", "진료내역을 작성해주세요.");
				return;
			}//end if
			
			if($("#opinion").val() == ""){
				alertCenter("#opinion", "#opinionAlert", "진료에대한 의견을 작성해주세요.");
				return;
			}//end if
							...
							<!-- Content -->
								<article>
									...
									<tr>
										...
										<tr>
										<td id="info" style="vertical-align: top">진료</td>
										<td id="input">
											 <textarea name=treatment rows="10" cols="35" maxlength="1000" style="width: 470px;" id="treatment"> 
											 </textarea>
										</td>
									</tr>
									<tr>
									...
									<table>
									<tr>
										<td id="info" style="vertical-align: top">의견서</td>
										<td id="input">
											 <textarea name=opinion rows="10" cols="35" maxlength="1000"  style="width: 470px;" id="opinion"> 
											 </textarea>
										</td>
									</tr>
