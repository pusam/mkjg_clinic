...
<link href="http://localhost:8080/mkjg/clinic/assets/color/default.css" rel="stylesheet">
  ...
  <style type="text/css">
		#id{background-color: #F5F5F5; height: 35px;}
        ...
        <div class="span12">
          <div class="centered">
            ...
            <table style="margin-left: 430px;">
				<tr>
					<td><input class="input-large" type="text"  placeholder="아이디" id="id" maxlength="20" /></td>
				...
				<tr>
						<td><input class="input-large" type="password" placeholder="비밀번호" id="pass" maxlength="20">	</td>
				</tr>
				<tr>
